...
public class GameManager : MonoBehaviour
{
    ...
    public void Play() // cette fonction permet de lancer le niveau
    {
        ...
        if(DifficultyLevel == 5 || DifficultyLevel == 6 || DifficultyLevel == 9) { // l'afficahge des graines est réactivés pour les niveaux ou la graine apparaît
    ...
    public void ComeBackToPlayground() { // cette fonction permet de désactiver l'affichage en cours pour faire réapparaître le menu du jeu avec tous les boutons
    ...
    public void OpenShop() { // permet d'afficher l'écran des skins
    ...
    public void OpenScore() { // permet d'afficher l'écran des classement de scores par niveau
    ...
    public void SetSeedsNumber(int seeds) { // permet de mettre à jour l'affichage
